...
if [ ! -e $CONTAINER_ALREADY_INITIALIZED ]; then
	...
	# Pull Code from Git
	#sudo -u airflow -H sh -c "git clone https://github.com/A2i2C/BigData-DHBW-MTG.git /home/airflow/BigData"
	sudo -u airflow -H sh -c "git clone https://github.com/marcelmittelstaedt/BigData.git /home/airflow/plugin"
...
#	sudo -u airflow -H sh -c "ln -s /home/airflow/BigData/airflow/dags/ /home/airflow/airflow/dags"
	sudo -u airflow -H sh -c "ln -s /home/airflow/plugin/exercises/winter_semester_2020-2021/05_airflow/plugins/ /home/airflow/airflow/plugins"
